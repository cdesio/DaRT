...
G4VPhysicalVolume *DetectorConstruction::Construct()
{
  ...
  G4Tubs *solidSeed = new G4Tubs("seed", 0., 10 * um, 20 * um, 0, 360 * degree);
  ...
  {
        G4Tubs *solidCell = new G4Tubs("cell", R[r]-(nucleusSize/2+ margin), R[r]+(nucleusSize/2+ margin), 20 * um, 0, 360 * degree);
