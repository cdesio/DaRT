...
void SteppingAction::UserSteppingAction(const G4Step *step)
{
  ...
  // Save phase space file in the DNA box reference frame. 
  // Particle entry position into the box is saved to the phase space file, 
  // and the distance travelled from this point in the DNA box reference frame 
  // tracked until a boundary is crossed. 
  // Particles are saved to the phase space file in the adjacent box.
