...
parser.add_argument("--part1_particleSource", type=str, help="particle: alphaRa224 etc.")
parser.add_argument("--part1_particleTime", type=str, help="maximum time to include (s)")
...
if args.part1_particleSource:
    part1_particleTime = float(args.part1_particleTime)
else:
    part1_particleTime = False

runClustering.runClustering(filename, outputFilename, fEMinDamage, fEMaxDamage, probIndirect, sugarPosFilename, filenamePhoton=filenamePhoton, continuous =continuous, part1_CopyNum = copy, simulationType = simulationType, part1_particleSource = part1_particleSource, part1_particleTime = part1_particleTime)
